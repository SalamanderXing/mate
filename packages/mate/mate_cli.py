...
class MateCLI:
    ...
    def share(self, source: str, target_path: str):
        """
        :param source: Path to the module to share. Must lie within the 'shared' folder. E.g. 'shared.my_shared_module
        :param target_path: Path to the target folder. E.g. 'models.my_model' (may not be another shared folder or an experiment)

        Shares a module"""
        self.api.share(source, target_path)
